module.exports = {
  ...
  onStart: async function ({ api, event, args, usersData, message }) {
    ...
    if (messageReply) {
      ...
      // Priority 2: Tagging someone
      targetID = Object.keys(mentions)[0];
      amountStr = args[args.length - 1]; // Usually the last arg is the amount
    ...
    if (targetID == senderID) {
      return message.reply("🤡 **𝖸𝗈𝗎 𝖼𝖺𝗇'𝗍 𝗀𝗂𝗏𝖾 𝗆𝗈𝗇𝖾𝗒 𝗍𝗈 𝗒𝗈𝗎𝗋𝗌𝖾𝗅𝗏𝖾, 𝗇𝗂𝖼𝖾 𝗍𝗋𝗒.**");
    }
    ...
    if (!receiverData) {
      return message.reply("❌ **𝖴𝗌𝖾𝗋 𝗇𝗈𝗍 𝖿𝗈𝗎𝗇𝖽 𝗂𝗇 𝗍𝗁𝖾 𝖽𝖺𝗍𝖺𝗉𝗅𝖺𝗌𝖾.**");
    }
    ...
    const reward = Math.floor(amount * 0.6); // 60% Reward
    ...
    return api.sendMessage(
      ...
      `🎁 **𝖦𝖾𝗇𝖾𝗋𝗈𝗌𝗂𝗍𝗒 𝖱𝖾𝗐𝖺𝗋𝖽:** *$${reward.toLocaleString()} (60%)*\n` +
