{
  ...
  "database": {
    "type": "mongodb",
    "uriMongodb": "mongodb+srv://Charles_Goatbot:bane2339@cluster0.obbefvz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    "autoSyncWhenStart": false,
    "autoRefreshThreadInfoFirstTime": true,
    "notes": "(1) type selects 'json' or 'sqlite' or 'mongodb'. If you choose mongodb, enter uri connect mongodb in the uriMongodb section. (2) autoSyncWhenStart will sync data on startup. (3) autoRefreshThreadInfoFirstTime will refresh thread info on first message."
  },
  ...
  "spamProtection": {
    ...
    "timeWindow": 10,
    "banDuration": 24,
    "notes": "Auto-ban threads when users spam commands. commandThreshold: number of commands, timeWindow: seconds, banDuration: hours"
  },
  "autoRestart": {
    "time": null,
  ...
  "optionsFca": {
    ...
    "autoReconnect": false,
    "notes": "Document here: https://github.com/NeoKEX/fca-neokex/README.md"
  }
}
